...
contract ControlStructures {
    ...
    /*
    Create a function called fizzBuzz that accepts a uint called _number 
    and returns a string memory. The function should return:
    ...
    */
    ...
    /*
    Create a function called doNotDisturb that accepts a _uint called _time, 
    and returns a string memory. It should adhere to the following properties:
        ...
        If _time is greater than 2200 or less than 800, 
                 revert with a custom error of AfterHours, 
